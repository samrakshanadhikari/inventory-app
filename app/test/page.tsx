    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="space-y-2">
          ...
          <a href="/dashboard" className="block text-blue-600 hover:text-blue-800">Go to Dashboard</a>
          <a href="/auth/signin" className="block text-blue-600 hover:text-blue-800">Go to Sign In</a>
        </div>
      </div>
    </div>
  );
